...
<div id="webcrumbs"> 
	  ...
	  <div className="w-36 bg-indigo-800 text-white flex flex-col">
	    <div className="p-5 flex items-center">
	      ...
	      <span className="text-xl font-semibold">Jijenge</span>
	    </div>
	  ...
	  <div className="flex-1">
	    ...
	    <div className="bg-white p-4 flex items-center justify-between shadow-sm">
	      ...
	      <div className="flex items-center space-x-4">
	        ...
	        <div className="relative">
	          <span className="absolute -top-1 -right-1 w-4 h-4 bg-indigo-600 rounded-full text-white text-xs flex items-center justify-center">2</span>
	        ...
	        <div className="relative">
	          <span className="absolute -top-1 -right-1 w-4 h-4 bg-indigo-600 rounded-full text-white text-xs flex items-center justify-center">5</span>
	          <button className="p-2">
	            <i className="material-symbols-outlined">mail</i>
	          </button>
	        </div>
	        ...
	        <div className="flex items-center">
	          <div className="w-8 h-8 rounded-full overflow-hidden mr-2">
	            <img src="https://images.unsplash.com/photo-1511367461989-f85a21fda167?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MzkyNDZ8MHwxfHNlYXJjaHwxfHxwcm9maWxlfGVufDB8fHx8MTc0OTQzNzk3OXww&ixlib=rb-4.1.0&q=80&w=1080" alt="Profile" className="w-full h-full object-cover" />
	          </div>
	          <div>
	        ...
	        <div className="col-span-3 bg-white p-4 rounded-lg shadow-sm">
	          <div className="flex flex-col items-center mb-4">
	            <div className="w-20 h-20 rounded-full border-4 border-indigo-600 p-1 mb-2">
	              <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MzkyNDZ8MHwxfHNlYXJjaHwyfHxwcm9maWxlfGVufDB8fHx8MTc0OTQzNzk3OXww&ixlib=rb-4.1.0&q=80&w=1080" className="w-full h-full rounded-full" alt="Profile" />
	            </div>
	          ...
	          <div className="flex justify-around mb-4">
	            <div className="text-center">
	              <div className="inline-block relative">
	                <svg className="w-14 h-14" viewBox="0 0 36 36">
	                  ...
	                  <circle cx="18" cy="18" r="16" fill="none" stroke="#f97316" strokeWidth="2" strokeDasharray="100" strokeDashoffset="35" transform="rotate(-90 18 18)"></circle>
	                </svg>
	                <div className="absolute inset-0 flex items-center justify-center text-sm">65%</div>
	              </div>
	            ...
	            <div className="text-center">
	              <div className="inline-block relative">
	                <svg className="w-14 h-14" viewBox="0 0 36 36">
	                  <circle cx="18" cy="18" r="16" fill="none" stroke="#e0e0e0" strokeWidth="2"></circle>
	                  <circle cx="18" cy="18" r="16" fill="none" stroke="#10b981" strokeWidth="2" strokeDasharray="100" strokeDashoffset="65" transform="rotate(-90 18 18)"></circle>
	                </svg>
	                <div className="absolute inset-0 flex items-center justify-center text-sm">35%</div>
	              </div>
	            ...
	            <div className="text-center">
	              <div className="inline-block relative">
	                <svg className="w-14 h-14" viewBox="0 0 36 36">
	                  <circle cx="18" cy="18" r="16" fill="none" stroke="#e0e0e0" strokeWidth="2"></circle>
	                  <circle cx="18" cy="18" r="16" fill="none" stroke="#10b981" strokeWidth="2" strokeDasharray="100" strokeDashoffset="35" transform="rotate(-90 18 18)"></circle>
	                </svg>
	                <div className="absolute inset-0 flex items-center justify-center text-sm">65%</div>
	              </div>
	            ...
	            <div className="col-span-10">
	              <div className="h-48 relative">
	                ...
	                <svg className="w-full h-full">
	                  <path d="M0,40 Q50,-10 100,60 T200,30 T300,70 T400,10 T500,60" fill="none" stroke="#6366f1" strokeWidth="3" />
	                  <path d="M0,100 Q50,130 100,80 T200,110 T300,90 T400,120 T500,80" fill="none" stroke="#10b981" strokeWidth="3" />
	      ...
	      <div className="bg-white p-4 rounded-lg shadow-sm">
	        ...
	        <div className="grid grid-cols-3 gap-4">
	          <div className="border rounded-lg p-4">
	            ...
	            <p className="text-xs text-gray-500 mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
	            <div className="flex justify-between items-center">
	              <div className="flex items-center">
	                <span className="inline-block px-3 py-1 text-xs bg-gray-200 rounded-full mr-2">REMOTE</span>
	              </div>
	          ...
	          <div className="border rounded-lg p-4">
	            ...
	            <div className="flex justify-between items-center">
	              <div className="flex items-center">
	                <span className="inline-block px-3 py-1 text-xs bg-pink-200 text-pink-700 rounded-full mr-2">PART TIME</span>
	              </div>
	          ...
	          <div className="border rounded-lg p-4">
	            ...
	            <div className="flex justify-between items-center">
	              <div className="flex items-center">
	                <span className="inline-block px-3 py-1 text-xs bg-purple-200 text-purple-700 rounded-full mr-2">FULLTIME</span>
	              </div>
	              <div className="text-xs text-gray-500">Manchester, England</div>
	            </div>
	          </div>
